...
class TrigFlowScheduler(SchedulerMixin, ConfigMixin):
    ...
    def set_timesteps(
        ...
        Args:
            num_inference_steps (`int`, *optional*):
                ...
                Can be omitted when ``timesteps`` is provided directly.
        """
        if timesteps is not None:
            ...
            self.num_inference_steps = len(self.timesteps) - 1
            ...
            if num_inference_steps is None:
                raise ValueError("num_inference_steps is required when timesteps is not provided")
    ...
    def step(
        ...
        if len(self.timesteps) > 1:
            ...
            if timeindex < (len(self.timesteps) - 1):
