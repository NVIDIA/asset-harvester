...
from multiview_diffusion.models.sparseviewdit import SparseViewDiTTransformer2DModelNative
from multiview_diffusion.utils.convert_checkpoint import convert_sana_ms_to_diffusers


def get_c_radio(device="cuda"):
    """Load the C-RADIO image encoder and processor from HuggingFace."""
    from patches.cradio_compat import patch_cradio_cache, patch_cradio_modules
