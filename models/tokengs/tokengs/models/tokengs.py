...
from tokengs.attention import EncDecBackbone, PatchEmbed
from tokengs.gs import GaussianRenderer
from tokengs.models.activations import ClipActivationHead, DirectClipHead, ObjaverseActivationHead
...
class TokenGS(nn.Module):
    ...
    def render_gaussians(
        self, gaussians: torch.Tensor, decoder_input: ModelInputDecoder, output_size=None
    ) -> dict:
        """
    ...
    def _compute_loss_from_renders(
        ...
        if self.opt.lambda_ssim > 0:
            from tokengs.fused_ssim import fused_ssim
