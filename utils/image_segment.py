...
# Ensure ncore_parser is importable when run from ah_public_latest
_SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
_REPO_ROOT = os.path.dirname(_SCRIPT_DIR)
_NCORE_SRC = os.path.join(_REPO_ROOT, "ncore_parser", "src")
if _NCORE_SRC not in sys.path:
    sys.path.insert(0, _NCORE_SRC)

from ncore_parser.image_segmentation import Mask2FormerSegmentationEstimator
