...
from ..schedulers import TrigFlowScheduler
from .sparseviewdit_pipeline import SparseViewDiTPipeline, retrieve_timesteps
    ...
    def __call__(
        ...
        *,
        ...
        with torch.autocast("cuda", dtype=model_dtype):
            ...
            print(f"   Denoising loop: {loop_ms / 1000:.2f}s ({loop_ms / n_steps:.1f}ms/step, {n_steps} steps)")
